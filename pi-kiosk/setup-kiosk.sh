...
sleep 1
runasp "$CHROMIUM" --app=http://127.0.0.1:5050/launcher.html --window-size=800,480 --window-position=0,0 --noerrdialogs --disable-infobars --disable-session-crashed-bubble &
EOF
